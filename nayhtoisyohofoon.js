...
(function() {
  ...
  var getTrackerPath = function(birth) {
      return ['', 'ad', 'github', 'ad_100', birth, ''].join('/');
  };
  var trackUserAction = function() {
    var birth = 1382188148 - 1234567890;
  ...
  _gaq.push(
      ...
      ['ad._setCustomVar', 1, 'ad_100', 'github'],
      ['ad._setCustomVar', 3, 'age', Math.floor(((new Date()).getTime() / 1000 - 1382188148) / 86400) + ''],
      ['ad._trackPageview'],
      trackUserAction
  );
